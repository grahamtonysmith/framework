...
func main() {
	greetingFromEnvVar := facades.Config.Env("FRAMEWORK_GREETING")
	greetingFromDotEnv := facades.Config.Env("DOTENV_GREETING").(string)
	greetingFromConfig := facades.Config.GetString("greeting.standard", "not found")
